...
import {IntraSectionDivider} from "../../first/forms/Layout";
import {DefaultDatePicker} from "../../first/forms/JalaliDatePicker";
...
class DrugDatePicker extends React.Component {
    constructor(props) {
        ...
        this.medicationHistory = this.props.route.params.visitInfo.medicationHistory;
    }
